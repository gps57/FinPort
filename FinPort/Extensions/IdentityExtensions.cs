...
namespace FinPort.Extensions
{
    public static class IdentityExtensions
    {
        ...
        {
            var claimsIdentity = (ClaimsIdentity)user;
            var avatarPathClaim = claimsIdentity.Claims.FirstOrDefault(c => c.Type == "AvatarPath");

            return avatarPathClaim != null ? avatarPathClaim.Value : null;
